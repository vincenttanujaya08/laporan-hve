...
import { 
  ...
  Wrench, Plus, BarChart3, 
  CheckCircle2, Clock, Package, Edit2
} from 'lucide-react';
...
// Added props for theme and lang
const Dashboard: React.FC<{ theme: string; lang: 'ID' | 'EN' }> = ({ theme, lang }) => {
